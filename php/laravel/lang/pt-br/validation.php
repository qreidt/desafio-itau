...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'document' => 'document',
        'transfer_password' => 'senha para transações',
        'type' => 'tipo',
        'sender_account_id' => 'conta do operador',
        'receiver_user_document' => 'documento do usuário receptor',
        'receiver_account_number' => 'número da conta receptora',
        'value' => 'valor',
        'password_combinations' => 'senha'
    ],
